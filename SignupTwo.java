...
public class SignUpTwo extends JFrame implements ActionListener {
    ...
    SignUpOne(){
        ...
        formno.setFont(new Font("Ralweay",Font.BOLD,38));
        formno.setBounds(140,20,600,40);
        add(formno);


        JLabel personalDetails =new JLabel("Page 1: Personal Details ");
        personalDetails.setFont(new Font("Ralweay",Font.BOLD,20));
        personalDetails.setBounds(290,80,400,30);
        add(personalDetails);


        JLabel name =new JLabel("Name : ");
        name.setFont(new Font("Ralweay",Font.BOLD,22));
        ...
        fname.setFont(new Font("Ralweay",Font.BOLD,20));
        ...
        dob.setFont(new Font("Ralweay",Font.BOLD,20));
        ...
        gender.setFont(new Font("Ralweay",Font.BOLD,20));
        ...
        mstatus.setFont(new Font("Ralweay",Font.BOLD,20));
        ...
        marriedStatus.add(others);


        JLabel email =new JLabel("Email Address : ");
        email.setFont(new Font("Ralweay",Font.BOLD,20));
        ...
        address.setFont(new Font("Ralweay",Font.BOLD,20));
        ...
        city.setFont(new Font("Ralweay",Font.BOLD,20));
        ...
        state.setFont(new Font("Ralweay",Font.BOLD,20));
        ...
        pin.setFont(new Font("Ralweay",Font.BOLD,20));
